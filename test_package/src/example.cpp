...
auto parse_number(std::string_view& str) -> mr::expected<double, parse_error>
{
    ...
    if (begin == end)
        return mr::unexpected(parse_error::invalid_input);
    else if (std::isinf(retval))
        return mr::unexpected(parse_error::overflow);
